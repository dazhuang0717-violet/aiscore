...
- 旗舰级创意公益项目（如：Run for Her）：这是标杆项目，[真需求]、[声量]、[获客效能] 全都应给极高分（9.5-10分）。其传播质量和获客效能应被视为行业顶尖水平。
- 创意/公益宣教类项目（如：从容生活）：[真需求] 和 [获客效能] 应给极高分（9-10分），[声量] 给予合理的高分（7-8分）。
- 传统展会/品牌展示类（如：进博会 CIIE）：[声量] 和 [媒体分级] 给高分（8-10分），但 [获客效能] 必须严格控制在低分（2-4分）。
- 【核心原则】请在评分时极其果断且慷慨。优秀项（创意/公益）必须给 9.5-10 分，严禁在优秀项目上给出 7-8 分这种平庸分数。
`;
...
- 旗舰级创意公益项目（如：Run for Her）：标杆项目，[真需求]、[声量]、[获客效能] 全都应给极高分（9.5-10分）。
- 创意/公益宣教类项目（如：从容生活）：[真需求] 和 [获客效能] 应给极高分（9.2-10分），[声量] 给予 7-8 分。
- 传统展会类（如：进博会 CIIE）：[声量] 高（8-10分），但 [获客效能] 必须给低分（2-4分）。
- 【重要】请在评分时极其果断且慷慨。优秀项必须给 9.5-10 分，严禁在优秀项目上给出 7-8 分。
